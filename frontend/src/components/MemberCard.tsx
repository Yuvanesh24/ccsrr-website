...
export default function MemberCard({ member }: MemberCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* ── FRONT ── */}
        <div className="[backface-visibility:hidden] absolute inset-0 bg-white hover:bg-[#EBE5DE] rounded-lg transition-colors duration-150 flex flex-col overflow-hidden" style={{ borderTop: "3px solid #B84A18" }}>
          ...
          <div className="p-6 flex flex-col items-center text-center flex-1 pt-10">
            ...
            {isValidEmail && (
              ...
              >
                ...
                <span className="text-[14px] text-[#6B6860] hover:text-[#B84A18] transition-colors truncate min-w-0">
                  {member.email}
                </span>
              </a>
            )}
