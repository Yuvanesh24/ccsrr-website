  ...
  if (submitted) {
    return (
      <div className="text-center py-12 card-base bg-white">
        ...
        <p className="font-semibold text-[#1C1C1A] text-[17px]">Message sent successfully</p>
        <p className="text-[15px] text-[#6B6860] mt-1">We will get back to you shortly.</p>
        <Button
          variant="outline"
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="space-y-2">
          <label htmlFor="name" className="text-[15px] font-medium text-[#1C1C1A]">
            Name <span className="text-red-500">*</span>
          </label>
          <Input id="name" name="name" required placeholder="Your name" className="border-[#E8E5E0]" />
        </div>
        <div className="space-y-2">
          <label htmlFor="email" className="text-[15px] font-medium text-[#1C1C1A]">
      ...
      <div className="space-y-2">
        <label htmlFor="message" className="text-[15px] font-medium text-[#1C1C1A]">
