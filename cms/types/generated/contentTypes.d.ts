...
export interface ApiDeviceDevice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Rehabilitation devices at CCSRR';
    displayName: 'Device';
    pluralName: 'devices';
    singularName: 'device';
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Events and activities at CCSRR';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<['Workshop', 'Seminar', 'Other']> &
      Schema.Attribute.Required;
...
export interface ApiGalleryItemGalleryItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Gallery images for CCSRR';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Events', 'Devices', 'Lab', 'Workshops', 'Visits', 'Outreach']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiMemberMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Team members of CCSRR';
    displayName: 'Member';
    pluralName: 'members';
    singularName: 'member';
  };
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email;
    group: Schema.Attribute.Enumeration<['team', 'former', 'collaborator']> &
...
export interface ApiPageContentPageContent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Dynamic page content (Vision, Mission, Objectives, etc.)';
  ...
  attributes: {
    ...
    contentList: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Research projects at CCSRR';
    displayName: 'Project';
    pluralName: 'projects';
  ...
  attributes: {
    ...
    coGuide: Schema.Attribute.Text;
    coPi: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
    ...
    fundingAgency: Schema.Attribute.String;
    ...
    projectType: Schema.Attribute.Enumeration<['Funded', 'PhD', 'Student']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    registrationYear: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'>;
    startDate: Schema.Attribute.Date;
    status: Schema.Attribute.Enumeration<['Ongoing', 'Completed', 'Upcoming']> &
      Schema.Attribute.Required;
    studentCategory: Schema.Attribute.Enumeration<['UG', 'PG']>;
    studentName: Schema.Attribute.String;
    studentNames: Schema.Attribute.Text;
    thesisTitle: Schema.Attribute.String;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Research publications from CCSRR';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Article', 'Review', 'Conference', 'Editorial']
    > &
